...
console.log(calculateRectangleArea(rectangleWidth, rectangleHeight));
...
function checkDistance(time, speedOne, speedTwo) {
    const distance = speedOne * time + speedTwo * time;
    return distance;
}

checkDistance(time, speedOfFirst, speedOfSecond);
...
if(randomNumber < 20) {
    ...
    console.log(`${randomNumber} is greater than 20 and less than 50`);
}
